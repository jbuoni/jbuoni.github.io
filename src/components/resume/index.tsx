...
import callrail from '../../assets//callrail.png'
import gtech from '../../assets//gtech.png'
import honeywell from '../../assets//honeywell.jpeg'
import mary from '../../assets//mary.png'
import rit from '../../assets//rit.png'
import verivo from '../../assets//verivo.jpeg'
import warnerresume from '../../assets//warnerresume.jpeg'
import westat from '../../assets//westat.png'
import veda from '../../assets//veda.jpeg'


const ContentWithFontAwesome = ({ text, faClass }: { text: any, faClass: any }) => {
    return (
      <>
...
const ResumeHeader = ({ title }: { title: string }) => {
    return (
        <>
...
const ResumeRow = ({ image, line1, line2, date, info}: ResumeRowProps) => {
    const infoArray = info && info.split('<b>') || []
    return (
        <div className="resume-item-container">
            ...
            <div className="resume-item">
                ...
                <div className="resume-info">
                    <ul>
                        {infoArray?.map((item: string, idx: number) => <li key={idx}>{item}</li>)}
                    </ul>
                </div>
                }
            </div>
...
const SkillsContainer = ({ skill, stars }: { skill: string, stars: number[] }) => {
    return (
        <div className="skill-container">
            <div className="skill-span">{skill}:</div>
            { stars.map((_, idx) => <i key={idx} className="fas fa-star star"></i>)}
        </div>
    )
}
                ...
                <div className="resume-content">
                    <div className="resume-content-right">
                        ...
                        <div className="skills">
                            ...
                            <SkillsContainer skill="DynamoDB" stars={[1,2,3]}/>
                            <SkillsContainer skill="GraphQL" stars={[1,2,3]}/>
                            <SkillsContainer skill="C++" stars={[1]}/>
                        </div>
                        <div className="skills">
                            <h3 className="resume-header">Concepts</h3>
                            <SkillsContainer skill="Front-end" stars={[1,2,3,4,5]}/>
                            <SkillsContainer skill="Back-end" stars={[1,2,3,4]}/>
                            ...
                            <SkillsContainer skill="UI/UX" stars={[1,2]}/>
                        </div>
                        <div className="skills">
                    ...
                    <div className="resume-mid">
                        <div className="resume-section">
                            ...
                            <ResumeRow
                                line1="Veda, Remote" line2="Senior Software Engineer" date="September 2021 - February 2025"
                                ...
                                <b> Worked as a member of a scrum team to maintain and develop an existing python data cleaning application which uses AI and machine learning to handle the parsing, formatting, validation, and enhancement of medical data supplied to us by insurance companies.
                            ...
                            <ResumeRow
                                ...
                                info={` Used TypeScript to develop and maintain Honeywell Forge Platform APIs and CLI tools used to produce IoT applications.
                                       ...
                                       <b> Used Typescript, React to create a simple components that could be accessed through an internal React SDK.
