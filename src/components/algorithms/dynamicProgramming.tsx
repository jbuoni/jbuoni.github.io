...
function CoinChange({ codeLanguageDict }: DynamicProgrammingProps) {
    return (
        <>
...
function Strings({ codeLanguageDict }: DynamicProgrammingProps) {
    return (
        <>
...
function Counting({ codeLanguageDict }: DynamicProgrammingProps) {
    return (
        <>
...
export default function DynamicProgramming ({ selected, codeLanguageDict }: DynamicProgrammingProps) {
    return (
        <>
