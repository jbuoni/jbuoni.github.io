...
function Dijkstras({ codeLanguageDict }: AlgorithmTypeProps) {
    const dstr = `
...
function Directed({ codeLanguageDict }: AlgorithmTypeProps) {
    const dstr = `
...
function UnDirected({ codeLanguageDict }: AlgorithmTypeProps) {
    const dstr = `
...
function Flood({ codeLanguageDict }: AlgorithmTypeProps) {
    const dstr = `
...
function Weighted({ codeLanguageDict }: AlgorithmTypeProps) {
    const dstr = `
    Given a matrix of size NxM where every element is either 'O' or 'X',
    replace 'O' with 'X' if surrounded by 'X'. A 'O' (or a set of 'O') is
    considered to be by surrounded by 'X' if there are 'X' at locations just
...
export default function Graphs ({ selected, codeLanguageDict }: AlgorithmTypeProps) {
    return (
        <>
